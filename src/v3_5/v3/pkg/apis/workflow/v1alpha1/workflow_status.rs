...
pub struct WorkflowStatus {
    ...
    pub artifact_gc_status: Option<Box<super::ArtGCStatus>>,

    #[serde(rename = "artifactRepositoryRef", skip_serializing_if = "Option::is_none")]
    pub artifact_repository_ref: Option<Box<super::ArtifactRepositoryRefStatus>>,
    ...
    pub stored_templates: Option<::std::collections::HashMap<String, super::Template>>,
