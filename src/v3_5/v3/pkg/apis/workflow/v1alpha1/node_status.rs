...
pub struct NodeStatus {
    ...
    /// ID is a unique identifier of a node within the workflow. It is implemented
    ...
    pub memoization_status: Option<Box<super::MemoizationStatus>>,
...
impl NodeStatus {
    pub fn new(id: String, name: String, r#type: String) -> NodeStatus {
        NodeStatus {
            boundary_id: None,
            children: None,
            daemoned: None,
